...
import { validateExpertiseAreas } from '../src/lib/expertiseValidation.js';
import { formatAndValidatePhone } from '../src/lib/phoneUtils.js';
...
async function runFullFunctionalTestSuite() {
  ...
  try {
    ...
    // We verify the query structure and execute insertion logic
